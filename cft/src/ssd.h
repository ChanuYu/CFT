...
int get_requests(struct ssd_info *, FILE *, int phase);
...
void trace_output(struct ssd_info*, FILE *);
void statistic_output(struct ssd_info *);
unsigned int size(unsigned int);
unsigned int transfer_size(struct ssd_info *,unsigned int,unsigned int,struct request *);
