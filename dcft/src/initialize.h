...
struct ssd_info{ 
    ...
    float slc_cache_table[7];
    int prev_slc_table_idx;
    int dwa_slc_blks;
    int migration_count;
    ...
    unsigned int slc_read_count;
    unsigned int slc_write_count;
    unsigned int total_sub_req_count;
...
struct page_info{
    ...
    int num_chunk;
    unsigned int lpns[4];
    unsigned int valid_states[4];
    unsigned int free_states[4];
};
